#!/bin/bash
#https://releases.ansible.com/ansible-tower/setup/?extIdCarryOver=true&sc_cid=701f2000001OH7YAAZ
...
bash setup.sh
sleep 2
[[ ! $( ps -ef|grep tower|grep -v grep|wc -l) -ge 1 ]] && echo "INSTALLATION OF TOWER WAS NOT SUCCESSFUL - PLEASE CHECK AND TRY AGAIN" || msg
}
